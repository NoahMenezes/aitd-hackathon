        ...
        <div className="bg-white/70 dark:bg-slate-900/40 backdrop-blur-3xl rounded-[3rem] border border-white/40 dark:border-white/10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] p-10 space-y-8">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-white/40 ml-4">
                {t.auth.emailAddress}
              </label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between px-4">
                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-white/40">
                  {t.auth.password}
                </label>
                <Link
                  href="#"
                  className="text-[10px] font-bold uppercase tracking-widest text-indigo-600 dark:text-indigo-400 hover:opacity-80 transition-opacity"
                >
                  {t.auth.forgot}
                </Link>
              </div>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="relative bg-[#F8FAFC] dark:bg-slate-950 px-4 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-white/40 transition-colors">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 bg-slate-100/50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 py-3 rounded-2xl transition-all">
              ...
              />
              <span className="text-xs font-bold">{t.auth.github}</span>
            </button>
            <button className="flex items-center justify-center gap-2 bg-slate-100/50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 py-3 rounded-2xl transition-all">
              <Globe2 size={18} className="text-slate-600 dark:text-white/60" />
              <span className="text-xs font-bold">{t.auth.google}</span>
            </button>
          </div>
